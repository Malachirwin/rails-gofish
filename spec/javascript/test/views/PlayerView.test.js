...
describe("PlayerView", () => {
  it('renders PlayerView', () => {
    const player = new Player({cards: [{rank: '2', suit: 'H', value: '2 of Hearts'}, {rank: '4', suit: 'D', value: '2 of Diamonds'}], matches: [], name: 'Malachi'}, true)
  ...
  it('doesn\'t render highlighted class if it is not your turn', () => {
    const player = new Player({cards: [{rank: '2', suit: 'H', value: '2 of Hearts'}, {rank: '4', suit: 'D', value: '2 of Diamonds'}], matches: [], name: 'Malachi'}, false)
    const wrapper = mount(<PlayerView targetCard="2" clicked={jest.fn()} player={player}/>)
